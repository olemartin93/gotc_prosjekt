...
<html>
  ...
  <body>
    ...
    <header>
      ...
      <img class="bilde-layout" src="bilder/vikerfjell.jpg" height="100%" width="100%">
...
<!-- laget av: Tobias, kontrollert av Christian -->
    <nav id="nav" role="navigation">
      <ul>
        ...
        <li><a href="servicetjenester.html">servcetjenester</a></li>
      ...
      <div class="content">
        <article class="topContent">
            ...
            <p>Vikerfjell.com<br>
              Vestre Ådal 922<br>
              3516 Hønefoss<br>
              Telefon: +47 930 11 567<br>
              NORWAY<br>
              E-post: post@vikerfjell.com</p>
        </article>
      </div>
    </div>
